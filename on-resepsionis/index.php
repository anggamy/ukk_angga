...
if ( !isset($_SESSION['user_login']) || 
    ( isset($_SESSION['user_login']) && $_SESSION['user_login'] != 'resepsionis' ) ) {
...
<html lang="en">
<head>
  <title>Resepsionis - L HOTEL</title>
  <meta charset="utf-8">
      ...
      <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="collapsibleNavbar">
           <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
            <li>
            <h5><a class="nav-link" href="../logout.php" id="logout">Logout</a></h5>
            </li>
          </ul>
        </div>
      </div>
...
<div class="modal fade" id="modal_lihat_reservasi">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <!-- Modal body -->
      <div id="pelanggan" class="modal-body">
      
      </div>

      <!-- Modal footer -->
      <div class="modal-footer">
        <p class="text-center">@anggamy_</p>
      </div>
