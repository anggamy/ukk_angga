...
<div id="invoice">
    ...
    <div class="invoice overflow-auto">
        <div style="min-width: 600px">
            <header>
                <div class="row">
                    ...
                    <div class="col company-details">
                        ...
                        <div>Bandung, TX 12345, Indonesia</div>
                        <div>(123) 456-789</div>
                        <div>lhotel@gmail.com</div>
                    </div>
                </div>
            </header>
            <main>
                <div class="row contacts">
                    <div class="col invoice-to">
                        ...
                        <div class="address">Bandung, TX 12345, Indonesia</div>
            ...
            <footer>
                Bukti pemesanan kamar L Hotel  Bandung - Jawa Barat - Indonesia.
            </footer>
        </div>
