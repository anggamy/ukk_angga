...
<nav class="navbar navbar-expand-sm navbar-dark bg-primary">
      <div class="container-fluid">
        <a class="navbar-brand" href="#">L HOTEL</a>
          ...
          <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              <h5><a class="nav-link" href="index.php">Login</a></h5>
            </li>
          </ul>     
    ...
    <div class="d-flex justify-content-center">
            <div class="row">
                <div class="col-sm form-floating mb-3 mt-4">
                    <button type="button" id="tombol_pesan" class="btn btn-outline-primary">Pesan Sekarang</button>
                </div>
            </div> 
    </div>
 </div>
    ...
    <div class="card d-flex justify-content-center">
        <div class="card-body bg-primary">
            <div class="row bg-primary text-white">
                ...
                <p>Masukan data pada form ini, untuk memulai pemesanan!</p>
            </div>
...
<div class="container mt-2" id="panel_fasilitas_kami">
    <h2 class="text-center" >FASILITAS HOTEL</h2>
      <h5 class="text-center">L Hotel</h5>
      ...
      <div class="card">
        ...
        <img class="img-fluid" max-width: 100%;  height: auto; src="image/hal12.jpg" alt="Gambar"> 
      </div>
      </div>
      <div class="container mt-4">
      <div class="card">
        <h4>GYM</h4>
        <p>The .img-fluid class makes the image scale nicely to the parent element (resize the browser window to see the effect):</p>
        <img class="img-fluid" max-width: 100%;  height: auto; src="image/hal4.jpg" alt="Gambar"> 
      </div>
      </div>
</div>
...
<div class="container mt-2 col-sm-7" id="panel_kamar">
  ...
  <div class="card mt-2 mb-4">
      <div class="">
        ...
        <img class="img-fluid" src="image/hal11.jpg" alt="Card image">
      </div>
    </div>
    <div class="card mt-2 mb-4">
      <div class="">
      ...
      <img class="img-fluid" src="image/hal10.jpg" alt="Card image">
      </div>
    </div>
